...
// ======================= ALUGUEL ========================== //
	...
	public static List<Cliente> consultarClienteNAlugueis(int n) {
		return daocliente.consultarClienteNAlugueis(n);
	}
	
	public static List<Aluguel> consulta1(String nome, String ano){
		return daoaluguel.clientesAlugueis(nome, ano);
	}
}